...
const { resolveBin, getConcurrentlyArgs, hasFile, pkg, parseEnv } = require('../utils');
...
if (deployOnceResults.status === 0) {
	...
	console.log('travis-deploy-once exited with a non-zero exit code', deployOnceResults.status);
